...
{
	return EnemyState == EEnemyState::EES_Atttacking;
}
...
void AEnemy::StartAttackTimer()
{
	...
	GetWorldTimerManager().SetTimer(AttackTimer, this, &AEnemy::IA_Attack, AttackTime);
}
